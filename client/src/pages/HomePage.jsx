    ...
    <>
      ...
      {products && categories ? (
        <div className="home px-6 flex md:flex-row flex-col justify-between gap-10 md:pb-0 pb-24 h-screen">
          <div className="categories overflow-auto max-h-[calc(100vh_-_128px)] md:pb-10 min-h-[125px]">
            <Categories
          ...
          <div className="products flex-[8] max-h-[calc(100vh_-_128px)] overflow-y-auto pb-10 min-h-[500px]">
            <Products
              categories={categories}
              filtered={filtered}
              products={products}
